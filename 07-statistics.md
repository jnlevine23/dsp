...
Answer we are trying to find = Probability Elvis was an identical twin given that he had a twin brother. 
```P(A) = Elvis was an identical twin
   P(B) = Elvis had a twin brother```
